...
<body style="background-color:#ffffff;color:#24292e;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif">
  <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:480px;margin:0 auto;padding:20px 0 48px">
    <tr>
      <td>
        <p style="font-size:24px;line-height:1.25;margin:16px 0"><strong>${name}</strong>, velkommen til Rego</p>
        <table style="padding:24px;border:solid 1px #dedede;border-radius:5px;text-align:center" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
          <tbody>
            <tr>
              <td>
                <p style="font-size:14px;line-height:24px;margin:0 0 10px 0;text-align:left">Hei <strong>${name}</strong>!</p>
                ...
                <a target="_blank" href="${verifyUrl}" style="display:inline-block;font-size:14px;background-color:#0D9488;color:#fff;line-height:120%;border-radius:0.5em;padding:0.75em 1.5em;text-decoration:none;margin-top:8px">
                  Bekreft e-post
                </a>
              </td>
            </tr>
        ...
        <p style="font-size:12px;line-height:24px;margin:16px 0;color:#6a737d;text-align:center">
          <a target="_blank" href="${verifyUrl}" style="color:#0366d6;text-decoration:none;font-size:12px">
            ${verifyUrl}
          </a>
        </p>
