...
const { createRoom, getRoomByCredentials, getMessages, newMessage, resetUnread } = require('../schemas/chat.schema');
...
router.get('/get/messages', ensureAuth, validate(getMessages, 'query'), chatController.getMessages);
